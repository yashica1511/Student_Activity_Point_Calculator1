                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2">
                        <div className='column1 p-6 sm:p-8 md:p-10 lg:p-12'>
                            <div className="flex items-start justify-center">
                                <div className="relative w-4 h-4 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 xl:w-12 xl:h-12 2xl:w-12 2xl:h-12 mt-8 sm:mt-6 md:mt-6 lg:mt-6 xl:mt-6 2xl:mt-4">
                            ...
                            <div className="mt-8 flex justify-end">
                                <button
                                    className="mt-6 py-2 px-4 w-24 sm:w-28 md:w-32 lg:w-36 h-12 rounded-md font-semibold focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-md bg-blue-500 text-white">
                                    Next
                                </button>
                            </div>
                        </div>
